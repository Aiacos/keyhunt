...
MODES_OBJS := $(OBJDIR)/modes/modes.o $(OBJDIR)/modes/mode_address.o $(OBJDIR)/modes/mode_xpoint.o $(OBJDIR)/modes/mode_rmd160.o $(OBJDIR)/modes/mode_vanity.o $(OBJDIR)/modes/mode_minikeys.o
