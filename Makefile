...
SEARCH_OBJS := $(OBJDIR)/search/search_xpoint.o $(OBJDIR)/search/search_rmd160.o $(OBJDIR)/search/search_bsgs.o $(OBJDIR)/search/search_minikeys.o $(OBJDIR)/search/search_address.o $(OBJDIR)/search/search_vanity.o
